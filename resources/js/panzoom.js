(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.panzoom = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
        ...
        function createPanZoom(domElement, options) {
            ...
            function keepTransformInsideBounds()
            {
                ...
                //Element being zoomed
                var clientRect = getClientRect();

                //Checking the X axis is inside the bounding box
                ...
                //Checking the Y axis is inside the bounding box
            ...
            function getBoundingBox() {
                ...
                if (!bounds && !boundBox) return // client does not want to restrict movement
                ...
                if(boundBox){
                    var boundBoxDims = boundBox.getBoundingClientRect();
                    return {
                        top: Math.ceil(boundBoxDims.height),
                        right: 0,
                        bottom: 0,
                        left: Math.ceil(boundBoxDims.width),
                    }
                }
            ...
            {
                //If the minimum zoom is 1 or less, and the current zoom is in that range, there's no need to pan
                if(getMinZoom() <= 1 && transform.scale <= 1) return false;
